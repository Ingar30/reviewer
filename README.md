...
A clean 12-page quality-first acceptance run selected 12 substantive reviewers and used four-way reviewer concurrency. The complete wrapper took 4,442 seconds (74 minutes) and reported 1,800,348 tokens: about 2,325 seconds and 163,244 tokens for Sol/high parser preflight, 68 seconds and 49,793 tokens for Sol/medium selection, 1,816 wall-clock seconds and 1,430,995 aggregate tokens for the concurrent Sol/xhigh reviewer panel, and 220 seconds and 156,316 tokens for the final Sol/xhigh editor. Treat these as scale examples, not estimates or billing guarantees.
